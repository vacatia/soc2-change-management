...
| Classification applied with documented judgment | Decision comment on the affected issue (the *SOC 2 Major Change* parent issue for a project-level Major) recording the group's call and rationale; the classification label reflects it |
